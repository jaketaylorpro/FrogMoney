...
function isAllowedTest(db)
{
    ...
    db.isAllowed(db.memberIsAllowed(testEmail),
        function(){logger.info('isAllowedTest-base passed');},
        function(err){
            if(err){
    ...
    db.isAllowed(db.memberIsAllowed('Test@abc.com'),
        function(){logger.info('isAllowedTest-case passed');},
        function(err){
            if(err){
    ...
    db.isAllowed(db.memberIsAllowed('nosuch@abc.com'),
        function(){logger.info('isAllowedTest-false failed');},
        function(err){
            if(err){
